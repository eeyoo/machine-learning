...
def img2vector(filename):
    ''' 32x32 binary image convert to 1x1024 vector '''
...
def handwritingClassTest():
    ...
    for i in range(m-nottrainNum):
        fileNameStr = trainingFileList[i]
        fileStr = fileNameStr.split('.')[0]
        classNumStr = int(fileNameStr.split('_')[0])  # parse number from file name
    ...
    for i in range(mTest):
        ...
        print "%3d the classifier came back with: %d, the real answer is %d"\
